...
const OUT = path.join(ROOT, ".audit-tmp", "phase31_runtime_raw.json");
const PORT = 8799;
...
const RUNS = [
  ...
  { page: "index.html", w: 1280, h: 800, inter: 0 },
  ...
  { page: "index.html", w: 320, h: 700, inter: 0 },
  // admin width matrix
  ...
  { page: "admin.html", w: 320, h: 700, inter: 0 },
  // static subject page matrix
  ...
  { page: "subjects/biology.html", w: 320, h: 700, inter: 0 },
...
(async () => {
  ...
  const audit = { generated: new Date().toISOString(), tool: "scripts/phase31/runtime.cjs", runs: [] };
